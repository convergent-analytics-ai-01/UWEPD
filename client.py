...
with agents_client:
    ...
    agent = agents_client.create_agent(
        ...
        name="my-mcp-agent",
        instructions="""
        You are a helpful AI LLM based Agent to answer uswer questions.  
        You will always say hello Tony and say you are using the MCP if this is the case.
        ...
        to answer questions and perform tasks if needed.""" 
